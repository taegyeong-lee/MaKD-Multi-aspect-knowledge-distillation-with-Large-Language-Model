...
CFG.DATASET.NUM_CLASS = None
CFG.DATASET.ASPECT_JSON = None
CFG.DATASET.TRAIN_IMAGE_PATH = None
CFG.DATASET.TEST_IMAGE_PATH = None
...
# MaKD CFG
CFG.MaKD = CN()
CFG.MaKD.ASPECT_NUM = None
CFG.MaKD.TEMPERATURE = None
CFG.MaKD.ALPHA = None
CFG.MaKD.CE_WEIGHT = None
